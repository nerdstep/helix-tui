...
const helpCommandText = "buy/sell/cancel/flatten/sync/watch/events/tab (cancel <id|prefix|#row>, watch list|add|remove|sync, events up|down|top|tail, tab overview|logs|strategy|system)"
